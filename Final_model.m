...
set_param('modelSim/Process Noise/Random Number', 'SampleTime',num2str('clock'));
...
set_param('modelSim/Noise Injection/Discrete-Time Integrator', 'SampleTime',num2str('clock'));
set_param('modelSim/Noise Injection/Quantizer', 'SampleTime',num2str('clock'));
% Simulation Output Parameters
simOut = sim('modelSim', 'StopTime',num2str(t_final),'SimulationMode','rapid','AbsTol','1e-5',...
